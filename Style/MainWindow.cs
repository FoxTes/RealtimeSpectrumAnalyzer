...
namespace Real_time_Spectrum_Analyzer.Style
{
    ...
    public partial class MainWindow
    {
        ...
        void WindowStateChanged(object sender, EventArgs e)
        {
            ...
            if (w.WindowState == WindowState.Maximized)
            {
                ...
                if (screen.Primary)
                {
                    containerBorder.Padding = new Thickness(SystemParameters.WorkArea.Left + 7, SystemParameters.WorkArea.Top + 7,
                    (SystemParameters.PrimaryScreenWidth - SystemParameters.WorkArea.Right) + 7, (SystemParameters.PrimaryScreenHeight - SystemParameters.WorkArea.Bottom) + 5);
                }
            }
            else
            {
